...
<div class="card">
    <div class="card-body">
        ...
        <div class="row">
            ...
            <form method="POST" action="<?= base_url() ?>doc_recibido/<?= isset($id) ? 'modificar' : 'agregar' ?>" class="col-sm-12">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="remitente" value="<?= isset($id) ? $remitente : '' ?>" placeholder="  Persona Dirigida">
                    <i class="form-group__bar"></i>
                </div>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
